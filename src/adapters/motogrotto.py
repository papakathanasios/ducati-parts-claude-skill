"""Moto Grotto adapter – UK motorcycle breaker (motogrotto.co.uk).

WooCommerce site. Dedicated used Ducati parts section.
...
class MotoGrottoAdapter(PlaywrightBaseAdapter):
    source_name = "motogrotto"
    language = "en"
    country = "GB"
    currency = "GBP"
    base_url = "https://motogrotto.co.uk"
