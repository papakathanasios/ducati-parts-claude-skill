"""Forza Moto adapter – French Ducati specialist (forza-moto.com).

200m2 dedicated to Ducati parts. Search via /recherche?search_query=QUERY.
"""
...
class ForzaMotoAdapter(PlaywrightBaseAdapter):
    source_name = "forza_moto"
    language = "fr"
    country = "FR"
    currency = "EUR"
    base_url = "https://www.forza-moto.com"

    def _build_search_url(self, query: str) -> str:
        return f"{self.base_url}/recherche?search_query={quote_plus(query)}"
